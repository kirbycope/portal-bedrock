...
scoreboard objectives add btn_05_01 dummy "Level 05 Button 01"
scoreboard players set @s btn_05_01 0
scoreboard objectives add btn_05_02 dummy "Level 05 Button 02"
scoreboard players set @s btn_05_02 0
