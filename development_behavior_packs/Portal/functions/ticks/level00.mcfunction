...
execute as @a[scores={progress=2..3}] run particle portal:material_emancipation_grid 11 63 12
...
# Level 00 - Elevator
execute at @e[scores={progress=3..},x=9,y=63,z=14,dx=4,dy=2,dz=4] run scoreboard players set @s progress 4
