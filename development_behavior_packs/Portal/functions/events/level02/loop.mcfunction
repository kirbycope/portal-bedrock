...
execute as @s[scores={loop_timer=82}] run playsound portal.open.1 @s 1.9 79 10
...
execute as @s[scores={loop_timer=162}] run playsound portal.open.1 @s -2 79 6.8
...
execute as @s[scores={loop_timer=242}] run playsound portal.open.1 @s -7.9 79 10
...
execute as @s[scores={loop_timer=322}] run playsound portal.open.1 @s -2 79 13.9
